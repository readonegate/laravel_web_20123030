 <header class="bg-white">
   <div class="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4 sm:px-6 lg:px-8">
     <a class="block text-teal-600" href="{{ route('blog.gallery') }}">
     ...
     <div class="flex flex-1 items-center justify-end md:justify-between">
       <nav aria-label="Global" class="hidden md:block">
         <ul class="flex items-center gap-6 text-sm">
           <li>
             <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('blog.gallery') }}"> Gallery
             </a>
           </li>

           <li>
             <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('blog.contact') }}"> Kontak </a>
           </li>

           <li>
             <a class="text-gray-500 transition hover:text-gray-500/75" href="{{ route('blog.profile') }}">
               Profil </a>
           </li>
         </ul>
       </nav>
